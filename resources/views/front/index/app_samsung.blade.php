    ...
    <div class="container">
        <div class="row">
            ...
            <div class="main col-md-9">
                ...
                <!-- page-title start -->
                <!-- ================ -->
                <h4 class="page-title">三星手机 - 系统权限设置</h4>
                <hr>
                <!-- page-title end -->
                <h5>1.初始安装，开启多个权限</h5>
                <p><img src="{{ \Illuminate\Support\Facades\URL::asset('/source/images/appdownload/samsung3.jpg') }}"></p>
                <h5>2.开启WapsPay的通知使用权</h5>
                <p>初次安装App后打开，会自动跳转到通知使用权页，找到WapsPay，并开启。</p>
                <p><img src="{{ \Illuminate\Support\Facades\URL::asset('/source/images/appdownload/samsung2.jpg') }}"></p>
                <h5>3.打开WapsPay、微信、支付宝3个APP的开机自启权限</h5>
                <p>在桌面找到系统自带的【自启动管理】中开启</p>
                <h5>4.在内存中锁住WapsPay、支付宝、微信，不要被系统清理</h5>
                <p>启动一次WapsPay、支付宝、微信。然后点击手机底部硬件按钮中的“设置”按钮，调起“一键清理”功能，按住图标向下拖拽，就可以把App锁住。</p>
                <p><img src="{{ \Illuminate\Support\Facades\URL::asset('/source/images/appdownload/samsung1.jpg') }}"></p>
