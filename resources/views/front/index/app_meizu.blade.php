    ...
    <div class="container">
        <div class="row">
            ...
            <div class="main col-md-9">
                ...
                <!-- page-title start -->
                <!-- ================ -->
                <h4 class="page-title">魅族手机 - 系统权限设置</h4>
                <hr>
                <!-- page-title end -->
                <h5>1.开启WapsPay的通知使用权</h5>
                <p>为更顺畅的使用WapsPay收款，避免收不到通知，通知延迟等情况，请检查以下设置，并按要求设置</p>
                <p>初次安装App后打开，会自动跳转到通知使用权页，找到WapsPay，并开启。</p>
                <p>后期要开启，请在系统【设置】 - 【安全】 - 【读取通知权限】中开启</p>
                <p><img src="{{ \Illuminate\Support\Facades\URL::asset('/source/images/appdownload/meizu1.jpg') }}"></p>
                <p><img src="{{ \Illuminate\Support\Facades\URL::asset('/source/images/appdownload/meizu2.jpg') }}"></p>
                <p><img src="{{ \Illuminate\Support\Facades\URL::asset('/source/images/appdownload/meizu3.jpg') }}"></p>
                <h5>2.打开WapsPay、微信、支付宝3个APP的开机自启权限</h5>
                <p>在桌面找到系统自带的【安全中心】APP -【权限管理】 - 【自启动】中开启</p>
                <p><img src="{{ \Illuminate\Support\Facades\URL::asset('/source/images/appdownload/meizu4.jpg') }}"></p>
                <p><img src="{{ \Illuminate\Support\Facades\URL::asset('/source/images/appdownload/meizu5-1.jpg') }}"></p>
                <h5>3.在内存中锁住WapsPay、支付宝、微信，不要被系统清理</h5>
                <p>启动一次WapsPay、支付宝、微信。然后在屏幕西方往上滑动，调起多任务卡，找到WapsPay、支付宝、微信，分别长按，就可以把App在内存中锁住。</p>
                <p><img src="{{ \Illuminate\Support\Facades\URL::asset('/source/images/appdownload/meizu6.jpg') }}"></p>
                <h5>4.把WapsPay、微信、支付宝3个App的推送通知全部开启</h5>
